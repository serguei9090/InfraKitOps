...
/**
 * Network Toolkit settings — moved here from the old NetworkSettingsDialog
 * (SETTINGS_MODULE_PLAN.md §2). Every field is a default the individual tools
 * read; per-tool Advanced params can still override.
 */
export function NetworkSettings() {
  ...
  return (
    <>
      ...
      <SettingsGroup title="Name resolution">
      ...
      <SettingsGroup title="IP geolocation">
